...
//        addDummyData();
        ...
        deleteCityButton.setOnClickListener(view -> {
            ...
            if (inDeleteMode) {
                ...
                promptText.setText("Select city to delete");
            } else {
                deleteCityButton.setBackgroundColor(getResources().getColor(R.color.button));
                promptText.setText("");
            }
        });
    ...
    public void deleteCity(City city) {
        ...
        // Remove from Firestore using the city name as the document ID
        DocumentReference docRef = citiesRef.document(city.getName());
